...
import P from "../images/BoysGirls/coat.jpg";
import P1 from "../images/BoysGirls/coat2.jpg";
import P2 from "../images/BoysGirls/coat3.jpg";
import P3 from "../images/BoysGirls/shw.jpeg";
import P4 from "../images/BoysGirls/sh3.jpg";
import P5 from "../images/BoysGirls/shw2.jpg";
import P6 from "../images/BoysGirls/kurta.jpg";
import P7 from "../images/BoysGirls/kurti.jpg";
import P8 from "../images/BoysGirls/trou.jpg";
import P9 from "../images/BoysGirls/jwel.jpg";
import P10 from "../images/BoysGirls/cap.jpg";
import lg from "../images/logo.png";
class BoysGirls extends React.Component {
  render() {
    return (
      <div className="back">
        <div className="main">
          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col-sm-md-lg-8">
                <div>
                  <img src={P} alt="Not Found" className="imag"></img>
                  <img src={P1} alt="Not Found" className="imag"></img>
                  <img src={P2} alt="Not Found" className="imag"></img>
                </div>
                <br></br>
                <br></br>
                <br></br>
                <div>
                  <img src={P3} alt="Not Found" className="imag"></img>
                  <img src={P4} alt="Not Found" className="imag"></img>
                  <img src={P5} alt="Not Found" className="imag"></img>
                </div>
                <br></br>
                <br></br>
                <br></br>
                <div>
                  <img src={P6} alt="Not Found" className="imag"></img>
                  <img src={P7} alt="Not Found" className="imag"></img>
                  <img src={P8} alt="Not Found" className="imag"></img>
                </div>
                <br></br>
                <br></br>
                <br></br>
                <div>
                  <img src={P9} alt="Not Found" className="imag"></img>
                  <img src={P10} alt="Not Found" className="imag"></img>
                </div>
                <br></br>
                <br></br>
                <br></br>
