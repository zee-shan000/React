...
import P from "../images/Women/kan.jpg";
import P1 from "../images/Women/neck.jpg";
import P2 from "../images/Women/neck2.jpg";
import P3 from "../images/Women/bag.jpg";
import P4 from "../images/Women/bag2.jpg";
import P5 from "../images/Women/bag3.jpg";
import P6 from "../images/Women/lc.jpg";
import P7 from "../images/Women/lc2.jpg";
import P8 from "../images/Women/lc3.jpg";
import P9 from "../images/Women/trou.jpg";
import P10 from "../images/Women/trou2.jpg";
import P11 from "../images/Women/tro3.jpg";
import P12 from "../images/Women/sh1.jpg";
import P13 from "../images/Women/sh2.jpg";
          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col-sm-md-lg-8">
                <div>
                  <img src={P} alt="Not Found" className="img"></img>
                  <img src={P1} alt="Not Found" className="img"></img>
                  <img src={P2} alt="Not Found" className="img"></img>
                </div>
                <br></br>
                <br></br>
                <br></br>
                <div>
                  <img src={P3} alt="Not Found" className="img"></img>
                  <img src={P4} alt="Not Found" className="img"></img>
                  <img src={P5} alt="Not Found" className="img"></img>
                </div>
                <br></br>
                <br></br>
                <br></br>
                <div>
                  <img src={P6} alt="Not Found" className="img"></img>
                  <img src={P7} alt="Not Found" className="img"></img>
                  <img src={P8} alt="Not Found" className="img"></img>
                </div>
                <br></br>
                <br></br>
                <br></br>
                <div>
                  <img src={P9} alt="Not Found" className="img"></img>
                  <img src={P10} alt="Not Found" className="img"></img>
                  <img src={P11} alt="Not Found" className="img"></img>
                </div>
                <br></br>
                <br></br>
                <br></br>
                <div>
                  <img src={P12} alt="Not Found" className="img"></img>
                  <img src={P13} alt="Not Found" className="img"></img>
                </div>
                <br></br>
                <br></br>
                <br></br>
