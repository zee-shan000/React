...
import P from "../images/Fragrances/female.jpg";
import P1 from "../images/Fragrances/female2.jpg";
import P2 from "../images/Fragrances/female3.png";
import P3 from "../images/Fragrances/male4.jpg";
import P4 from "../images/Fragrances/kid2.jpg";
import P5 from "../images/Fragrances/kid3.jpg";
import P6 from "../images/Fragrances/kids.jpg";
import P7 from "../images/Fragrances/male2.webp";
import P8 from "../images/Fragrances/male3.jpg";
import P9 from "../images/Fragrances/male.jpg";
import lg from "../images/logo.png";
class Fragrances extends React.Component {
  render() {
    return (
      <div className="back">
        <div className="main">
          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col-sm-md-lg-8">
                <div>
                  <img src={P} alt="Not Found" className="image1"></img>
                  <img src={P1} alt="Not Found" className="image1"></img>
                  <img src={P2} alt="Not Found" className="image1"></img>
                </div>
                <br></br>
                <br></br>
                <br></br>
                <div>
                  <img src={P3} alt="Not Found" className="malee"></img>
                </div>{" "}
                <br></br>
                <br></br>
                <br></br>
                <div>
                  <img src={P4} alt="Not Found" className="image1"></img>
                  <img src={P5} alt="Not Found" className="image1"></img>
                  <img src={P6} alt="Not Found" className="image1"></img>
                </div>
                <br></br>
                <br></br>
                <br></br>
                <div>
                  <img src={P7} alt="Not Found" className="image1"></img>
                  <img src={P8} alt="Not Found" className="image1"></img>
                  <img src={P9} alt="Not Found" className="image1"></img>
                </div>
                <br></br>
                <br></br>
                <br></br>
